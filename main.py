...
@dp.message_handler(lambda message: Trigger['Main'])
...
@dp.message_handler(lambda message: Trigger['Rasp'])
...
@dp.message_handler(lambda message: Trigger['Profile'])
...
@dp.message_handler(lambda message: Trigger['Change_course'])
...
@dp.message_handler(lambda message: Trigger['Change_surname'])
...
@dp.message_handler(lambda message: Trigger['Admin'])
